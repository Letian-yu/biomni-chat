...
export interface ExtToWebview {
  type: "status" | "done" | "error" | "ready" | "clarification_question" | "plan_draft" | "report" | "mention_files" | "act_start" | "reasoning" | "stream" | "settings_data" | "settings_test_result" | "deploy_result" | "deploy_progress" | "title"
  ...
  fresh?: boolean // act_start 是否新建执行卡片（plan 确认后=true；ask/act 直接执行=false）
...
export interface BridgeResponse {
  type: "status" | "done" | "error" | "pong" | "ready" | "clarification_question" | "plan_draft" | "report" | "act_start" | "reasoning" | "stream"
  text?: string
  result?: string
  message?: string
  id?: number
